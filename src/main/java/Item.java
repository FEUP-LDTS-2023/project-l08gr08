...
public class Item extends Element{
    ...
    public void draw(TextGraphics graphics) {
        ...
        else if(id == 2) graphics.putString(new TerminalPosition(getPosition().getX(), getPosition().getY()), "2");
        else graphics.putString(new TerminalPosition(getPosition().getX(), getPosition().getY()), "3");
    }
}